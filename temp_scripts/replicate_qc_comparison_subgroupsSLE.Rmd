...
Define directory where data is and output directories.
```{r dirs}
...
## Plot significant proteins (START HERE)
...
```
merged results (log2FC > 1, log2FC < 1, pval > 0.5 and pval < 0.5.
```{r volcanos_annotated_allsignif}
sig_pval <- 0.05
...
ComplexHeatmap::Heatmap(
  ...
  #column_km = 4 # user knn to cluster columns
)
```

# Distribution plots for varios proteins.
